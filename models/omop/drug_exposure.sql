...
select
  row_number() over (order by newid())::bigint as drug_exposure_id,
  ...
  @generate_surrogate_key(person_id,visit_occurrence_id,drug_concept_id,drug_exposure_start_datetime,adm_route,last_edit_time) as unique_key,
